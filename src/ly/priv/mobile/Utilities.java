...
public class Utilities {
	 ...
	 *
	 * @param context
	 *            Context of the class which calls this method.
	 * @param textToToast
	 * @param longToast
	 */
	...
	/*
	 * public static String androidEncoder(String url) { url.replace("/",
	 * "AndroidSlash").replace().replace().replace(); return encodedUrl; }
	 */
