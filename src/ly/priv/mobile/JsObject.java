 ...
 * @author Shivam Verma
 * 
 * This class acts as a bridge between the Js of the Posting Applications and the 
...
public class JsObject {
	...
	/**
	 * 
	 * @param callingContext sets current context as the context of the calling class.
	 */
    ...
    /**
     * Shows the Share screen {@link ly.priv.mobile.Share} to the user 
