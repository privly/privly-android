...
public class Home extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		ArrayList createArrayList = new ArrayList<String>(
		...
		ArrayAdapter<String> createArrayAdapter = new ArrayAdapter<String>(
				this, android.R.layout.simple_list_item_1, createArrayList);
		...
		createListView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1,
				...
				Intent gotoCreateNewPost = new Intent(getApplicationContext(),
						NewPost.class);
